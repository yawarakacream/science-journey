...
また，あくまで $\textcolor{blue}{1} + \varepsilon_{M} > \textcolor{blue}{1}$ であることに注意します．$\textcolor{red}{0} + \varepsilon_{M} > \textcolor{red}{0}$ をみたす最小の正の数はマシンイプシロンではありません．

浮動小数点数の世界では $\textcolor{blue}{1} + \varepsilon_{M} > \textcolor{blue}{1}$ と $\textcolor{red}{0} + \varepsilon_{M} > \textcolor{red}{0}$ は同値ではないのです．
