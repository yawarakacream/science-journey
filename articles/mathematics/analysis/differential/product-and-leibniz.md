...
証明は難しくないですが変形が大変です．  
$\newcommand{\comb}[2]{{}_{#1} \mathrm{C} {}_{#2}} \comb{m}{k - 1} + \comb{m}{k} = \comb{m + 1}{k}$ が非自明ですが，よく考えるとパスカルの三角形の定義を述べていることがわかります．
